  ...
  return (
    ...
    >
      <header className="px-5 pt-12 pb-4 bg-white sticky top-0 z-10 shadow-sm flex items-center gap-4">
        ...
        <h1 className="text-xl font-heading font-bold text-[#212529]">Privacidade e Segurança</h1>
      </header>

      <div className="px-5 pt-6">
        <div className="bg-white rounded-2xl shadow-sm border border-[#E9ECEF] overflow-hidden mb-6">
          <SettingOption icon={<ShieldCheck size={20} className="text-[#2EC4B6]" />} label="Verificação de Segurança" />
          <div className="h-px bg-[#E9ECEF] mx-4" />
          <SettingOption icon={<Lock size={20} className="text-[#FF6B35]" />} label="Alterar Palavra-passe" />
          <div className="h-px bg-[#E9ECEF] mx-4" />
          <SettingOption icon={<Eye size={20} className="text-[#0D6EFD]" />} label="Gerir Dados Pessoais" />
          <div className="h-px bg-[#E9ECEF] mx-4" />
          <SettingOption icon={<FileText size={20} className="text-[#6C757D]" />} label="Termos e Condições" />
        </div>
      </div>
    </motion.div>
  );
